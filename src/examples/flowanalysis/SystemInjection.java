...
public abstract class SystemInjection
{
    ...
    {
        // Command injection:
        // Providing " & shutdown -s -f -d p" as command_parameter value in the request will 
