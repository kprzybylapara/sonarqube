...
public class XMLInjection
{
     ...
     * @param sDataType
     * @param sData
     * @throws RemoteException - indicates that this method is remote
     */
    void createXMLDocumentAndStoreData(
        Document document, 
        String sUserId, 
        String sUserName, 
        String sDataType, 
        ...
        throws RemoteException
    {
        ...
        // internal purposes, even passed as a data source to some critical processing method. 
        // It can also be traversed using JXpath or Digester which can 
        // create malicious objects that would cause dangerous code to be executed .
