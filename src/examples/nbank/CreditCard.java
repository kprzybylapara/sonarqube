 ...
 * the class. Jtest automatically uses the CreditCard sample object
 * defined by user to generate a valid credit card object.
 * 
 * @see CreditCard
 */
public class CreditCard
{
     ...
     */
    public CreditCard(int balance, String id, String securityNumber,
            String name, String zipcode, String creditCardNumber)
            throws IllegalArgumentException {
        super();
    ...
    private boolean validate() {
        return validate(new int[] { 5 }, _zipcode)
                ...
                && _currentBalance > 0 && _customerId.length() != 0
