...
public class MoneyTest
{
    ...
    /**
     * Test covers issue related to problem 12345
     * 
     * @pr 12345
     */
    @Test
    public void testBagMultiply()
    {
        ...
        IMoney expected = createMoneyBag(24, "CHF", 14, "USD");
        assertEquals(expected, fMB1.multiply(2));
        assertEquals(fMB1, fMB1.multiply(1));
        assertTrue(fMB1.multiply(0).isZero());
    }

    public IMoney createMoneyBag(int amountFirst, String currencyFirst, int amountSecond, String currencySecond)
    {
        Money moneyFirst = new Money(amountFirst, currencyFirst);
        Money moneySecond = new Money(amountSecond, currencySecond);
        IMoney moneyBag = MoneyBag.create(moneyFirst, moneySecond);
        return moneyBag;
    }
